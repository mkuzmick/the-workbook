...
import Balatro from '@/blocks/backgrounds/Balatro/Balatro'; // Adjust the import path as needed
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-black">
      <AnimatePresence mode="wait">
        ...
        >
          {/* Balatro background inserted as an absolutely positioned element */}
          <Balatro
            isRotate={false}
