...
import Iridescence from '@/blocks/backgrounds/Iridescence/Iridescence'; // Adjust the import path if needed
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-black">
      <AnimatePresence mode="wait">
        ...
        >
          {/* Insert Iridescence background as an absolutely positioned element */}
          <Iridescence
            color={[.3, 0.1, 0.1]}         // Color filter; adjust as needed
            mouseReact={false}         // Disable mouse reaction if desired
            amplitude={0.5}            // Low amplitude for subtle effect
