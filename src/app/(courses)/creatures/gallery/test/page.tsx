...
export default function Page() {
    ...
    // Poll every 5 seconds to add new cards (only update state if there are new cards)
    useEffect(() => {
        const intervalId = setInterval(async () => {
            ...
            setCards((prevCards) => {
                ...
                if (newCards.length === 0) {
                    return prevCards; // No change, so don't update state
                }
    ...
    // Add keydown listener for left/right arrow navigation
    useEffect(() => {
            ...
            <AnimatePresence mode="wait">
                ...
                >
                    ...
                    <div className="relative z-10 w-full">
                        {imageUrl ? (
                            // Use w-full so the container respects the parent's padding.
