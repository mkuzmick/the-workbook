    ...
    const handleDejargonify = async () => {
        ...
        try {
            ...
            while (true) {
                ...
                setStreamingMarkdown((prev) => prev + chunk); // Append to markdown content
            }
        } catch (error) {
    ...
    return (
        <main className="min-h-screen p-6 bg-gray-900 text-gray-200">
            <div className="max-w-6xl mx-auto grid grid-cols-2 gap-4">
                ...
                {/* Right Column: Markdown Response */}
                <div className="p-4 bg-gray-800 rounded-lg overflow-y-auto max-h-[70vh]">
                    {streamingMarkdown ? (
                        <ReactMarkdown className="prose prose-invert">{streamingMarkdown}</ReactMarkdown>
                    ) : (
